...
const MapPositions = ({
  ...
  const iconScale = useAttributePreference("iconScale", desktop ? 1.2 : 1.5);
  ...
  const createFeature = (devices, position, selectedPositionId) => {
    ...
    return {
      ...
      color:
        device.attributes["web.reportColor"] || showStatus
